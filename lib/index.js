...
exports.register = (server, options, next) => {
  ...
  server.ext('onPreResponse', (request, reply) => {
    ...
    const approximateCountValid = !Joi.validate(request, ApproximateCountValidator, { allowUnknown: true }).error;
    const totalCountValid = !Joi.validate(request, TotalCountValidator, { allowUnknown: true }).error;
